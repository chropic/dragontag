...
- `/library` browse (tabs per LibraryFolder, sortable/paginated track table), individual +
  helper/report actions
- `/completions` — library-health report (missing tracks, duplicates, lyrics/cover/genre
  gaps, untagged, tag problems); absorbed the old `/library/incomplete` tab
